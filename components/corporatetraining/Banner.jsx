        ...
        <section className="relative h-screen">
            ...
            <div className="relative z-10 flex flex-col justify-center h-full container space-y-5 p-5 md:p-0">
                <div className="relative">
                    <h1 className="text-white md:text-[#282C32] text-2xl md:text-[64px] font-bold leading-none capitalize md:pr-[50%]">
                ...
                <p className="text-base md:text-lg text-white md:text-[#282C32] md:pr-[60%]">
