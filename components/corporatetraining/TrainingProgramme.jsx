    ...
    return (
        <section className='py-8 md:py-24'>
            ...
            <div className='container grid grid-cols-1 md:grid-cols-2 gap-5 p-5'>
                <CommonCard link="#" variant='corporate' src={image1} point1=' Master embedded C/C++ and RTOS concepts' point2='Debug complex hardware/software interactions' point3='Debug complex hardware/software interactions' heading='Embedded Systems Core Training' subheading='Key Focus: Foundations to Advanced Firmware Skills' />
                <CommonCard link="#" variant='corporate' src={image2} point1='Implement secure boot and OTA update mechanisms' point2='Mitigate side-channel attacks and vulnerabilities' point3='Achieve industry certifications (e.g., IEC 62443)' heading='Secure Embedded Firmware Development' subheading='Key Focus: Threat Modeling, Fuzz Testing, Compliance' />
                <CommonCard link="#" variant='corporate' src={image3} point1='Design fail-safe systems for automotive/medical devices' point2='Navigate functional safety certification processes' point3='Apply MISRA/CERT coding standards' heading='Safety-Critical Firmware Engineering' subheading='Key Focus: ISO 26262, DO-178C, IEC 62304 Readiness' />
                <CommonCard link="#" variant='corporate' src={image4} point1='Accelerate product lifecycle from prototype to production' point2='Implement robust IP protection strategies' point3='Optimize firmware for mass production testing' heading='Embedded Innovation Leadership' subheading='Key Focus: IP Protection, Manufacturing Readiness' />
            </div>
        </section>
    )
}
