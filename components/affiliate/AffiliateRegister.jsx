        ...
        <section className='container py-10 md:py-24'>
            <div className='flex flex-col md:flex-row gap-10 items-center md:justify-between p-5 md:p-0 md:px-10'>
                <div className='w-full md:w-1/2 space-y-4'>
                    ...
                    <p className='text-start text-sm md:text-lg '>We're excited to welcome you to our Affiliate Program and give you the opportunity to earn a commission by promoting our embedded systems courses. By joining now, you'll gain access to our comprehensive Affiliate Dashboard, marketing materials, and dedicated support team. To join, simply click the button below. Our team will then send you an email with all the information you need to get started, including access to your Affiliate Dashboard. Don't have any questions? Great! If you do, however, we're here to help. Contact us at EmbeddedExpert.io and we'll provide you with the support and resources you need to succeed.</p>
