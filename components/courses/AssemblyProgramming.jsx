...
const AssemblyProgramming = () => {
    ...
    useEffect(() => {
        ...
        const AssemblyProgramming = courses.filter((course) => course.category === "Assembly Programming");
        setCourses(AssemblyProgramming);
    }, []);
    ...
    return (
        <section className="container clear-start mt-5 py-10 md:py-24 p-5 md:p-0">
            <Heading varient="nopx" cn="text-start mb-5" text="Assembly Programming" />
...
export default AssemblyProgramming;
