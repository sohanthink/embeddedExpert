...
const RtosProgramming = () => {
  ...
  useEffect(() => {
    ...
    const RtosProgramming = courses.filter(
      (course) => course.category === "RTOS Programming"
    );
    setCourses(RtosProgramming);
  }, []);
  ...
  return (
    <div className="bg-tertiary">
      <section className="container clear-start py-10 md:py-24  p-5 md:p-0">
        <Heading varient="nopx" cn="text-start mb-5" text="RTOS Programming" />
        <Swiper
          slidesPerView={5}
          grid={{
            rows: 2,
          ...
          breakpoints={{
            ...
            1440: {
              slidesPerView: 5, // 4 slides per row on larger screens
...
export default RtosProgramming;
