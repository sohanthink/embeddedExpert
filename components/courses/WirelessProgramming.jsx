...
const WirelessProgramming = () => {
    ...
    useEffect(() => {
        ...
        const WirelessProgramming = courses.filter(
            (course) => course.category === "Wireless Programming"
        );
        setCourses(WirelessProgramming);
    }, []);
    ...
    return (
        <div className="bg-tertiary">
            <section className="container clear-start py-10 md:py-24  p-5 md:p-0">
                <Heading varient="nopx" cn="text-start mb-5" text="Wireless Programming" />
                <Swiper
                    slidesPerView={5}
                    grid={{
                        rows: 2,
...
export default WirelessProgramming;
