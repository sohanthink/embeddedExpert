...
const Navbar = () => {
    ...
    return (
        <nav className='container md:w-[70%] absolute md:fixed md:bg-tertiary/80 rounded-full top-0 md:top-5 left-1/2 transform -translate-x-1/2 flex justify-between items-center px-5 md:px-10 py-4 z-[999]'>
